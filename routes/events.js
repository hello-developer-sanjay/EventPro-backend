...
router.post(
  ...
  async (req, res) => {
    console.log('POST /api/eventpro/events - Request received:', req.body);
...
router.get('/', auth, async (req, res) => {
  console.log('GET /api/eventpro/events - Request received');
  try {
...
router.get('/:id', auth, async (req, res) => {
  console.log('GET /api/eventpro/events/:id - Request received with ID:', req.params.id);
...
router.put('/:id', auth, async (req, res) => {
  console.log('PUT /api/eventpro/events/:id - Request received with ID:', req.params.id);
...
router.delete('/:id', auth, async (req, res) => {
  console.log('DELETE /api/eventpro/events/:id - Request received with ID:', req.params.id);
